...
public class Beta_Website_Search_Chrome_Api {

	public Beta_Website_Search_Chrome_Api() {
		super();
	}
	...
	@Test
	public void Verify_Beta_Website_Search_Chrome_Api() {
		...
		requestparams.put("hostname", "papajohns.com");
