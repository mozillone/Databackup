...
public class G_Suite_Data_Scrape_links {
	...
	public void Get_all_Business_names() throws InterruptedException, FileNotFoundException {
		...
		System.setOut(new PrintStream(new FileOutputStream("Googlescrape.txt")));
		...
		while(true){
			...
			if (Element.isDisplayed()) {
				...
				(driver.findElement(By.xpath("//h3[contains(text(),'The Dealio LLC')]"))).getText();
	...
	@Test(priority=2)
			public void Get_all_Business_names2() throws InterruptedException{
        ...
        System.out.println("Completed Scraping the Urls"); 
